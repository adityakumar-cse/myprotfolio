  ...
  >
    ...
    <div className="text-center mb-8">
      ...
      <p className="text-gray-400 mt-4 text-lg font-semibold">
        collection of my technical skills and expertise developed through hands-on projects and practical experience.
      </p>
    </div>
          ...
          >
            <div className="flex flex-wrap gap-4 justify-center">
              {category.skills.map((skill) => (
                <div
                  key={skill.name}
                  className="flex items-center gap-2 border-2 border-gray-700 rounded-3xl py-2 px-4"
                >
                  <img
                    src={skill.logo}
                    alt={`${skill.name} logo`}
